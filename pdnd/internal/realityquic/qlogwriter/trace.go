...
import (
	...
	"github.com/aegispanel/nodeagent/internal/realityquic/qlogwriter/jsontext"
)
...
// -ldflags="-X github.com/aegispanel/nodeagent/internal/realityquic/qlogwriter.quicGoVersion=foobar"
...
func init() {
	...
	for _, d := range info.Deps {
		if d.Path == "github.com/aegispanel/nodeagent/internal/realityquic" {
