...
internal/: NativeCore 底层实现。nativewire/ 协议线格式（anytls/hysteria2/mkcp/shadowtls/tuic/udpmask）；reality/ fork 的 crypto/tls（TLS 1.2 + 1.3）承载 REALITY 握手；realityquic/ 自带 LICENSE 的 QUIC 栈，193 文件
