...
**进度**：①（合并 b3eea00，R105）、②（合并 4b21102，R109）、③（合并 2125afa，R111）、④（合并 b8f8520，R113）、⑤ `8026cd0`（合并 e7e72a8，R115；PG18 run 36201969372：232 PASS / 0 SKIP / 0 FAIL；冒烟翻断言后与之同批合入）已验收合入。**⑥（R116）在做：⑤ 已合入主线，可以推送了**——`git merge feat/panel-redesign` 后推送、看三组 CI、报告。迁移 00095–00098 未用。
