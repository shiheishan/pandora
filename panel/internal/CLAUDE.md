...
domain/: 13 个业务域包共 90 文件，billing、nodefabric、dbbackup 最重；见 domain/CLAUDE.md
...
platform/: 17 个基础设施包共 138 个非测试 Go 文件，clientauth 占 107；webapp 为 admin/public 两个网关下发 React 候选前端；见 platform/CLAUDE.md
