...
成员清单
api/: 三个域网关的 HTTP 路由与处理器，admin 32 文件、public 13 文件、node 3 文件；见 api/CLAUDE.md
domain/: 13 个业务域包共 99 个非测试 Go 文件，billing、nodefabric、dbbackup 最重；见 domain/CLAUDE.md
