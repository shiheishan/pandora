...
const rows: Row[] = [
  ...
  { at: 'nodes/queries.ts:95', seed: '后台 PUT nodes/{id}/routing', list: 'routes', path: `v1/nodes/${s.node_id}/routing`, schema: nodeRoutingSchema },
  { at: 'nodes/queries.ts:101', seed: '后台 PUT nodes/routing（reauth + 幂等）', list: 'routes', path: 'v1/nodes/routing', schema: globalRoutingSchema },
